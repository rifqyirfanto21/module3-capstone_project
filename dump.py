...
from scripts.db_utils import insert_users, insert_payment_methods, insert_shipping_methods, insert_products, insert_transactions
from scripts.generate_data import generate_users, generate_payment_methods, generate_shipping_methods, generate_products, generate_transactions
...
with DAG(
    ...
    load_users >> load_payment_methods >> load_shipping_methods >> load_products
